...
cask "alfred"              unless Dir.exists?('/Applications/Alfred.app')
...
cask "brave-browser"       unless Dir.exists?('/Applications/Brave.app')
...
cask "karabiner-elements"  unless Dir.exists?('/Applications/Karabiner-elements .app')
...
cask "vlc"                 unless Dir.exists?('/Applications/Vlc.app')
cask "vmware-fusion"       unless Dir.exists?('/Applications/Vmware Fusion .app')
